...
<h1 align="center">
  React Full Stack Anim App
</h1>

使用React、Typescript、Graphql开发的全栈动漫网站。默认使用ts+hooks写法。

|*|使用技术|
|----|----|
|前台|gatsby.js+framer-motion+styled-components|
|后台|gatsby.js(react)+framer-motion+styled-components|
|后端|express(nest.js)+graphql|
...
1. **Clone this git repo.**
   ...
   Use the Git CLI to clone this repo.

   ```shell
   # clone the repo
   git clone https://github.com/ppxb/universe-g.git
   ```
...
1. **Open the source code and start editing!**
   ...
   Open the `my-hello-world-starter` directory in your code editor of choice and edit `src/pages/index.tsx`. Save your
